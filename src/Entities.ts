...
const DK_ENTITIES: Record<string, DkEntity[]> = {
    ...
    [ParamType.Player]: [
        ...
        { val: "PLAYER5", doc: "The ORANGE player", },
        { val: "PLAYER6", doc: "The BLACK player", },
        ...
        { val: "ORANGE", doc: "PLAYER5's equivalent", },
    ...
    [ParamType.KeeperIndex]: [
        ...
        {
            val: "5",
            doc: "The orange player - PLAYER5",
        },
        {
            val: "6",
            doc: "The black player - PLAYER6",
        },
    ],
    ...
    [ParamType.GameRule]: [
        { val: "BodiesForVampire", doc: "Number of bodies the graveyard needs to create a vampire", },
        { val: "PrisonSkeletonChance", doc: "The chance that a dying humanoid in prison creates a skeleton", },
        { val: "GhostConvertChance", doc: "The chance that a creature dying from torture creates a ghost", },
        { val: "TortureDeathChance", doc: "The chance a victim broken from torture dies", },
        { val: "TortureConvertChance", doc: "When the broken enemy does not die from torture, it can either reveal information or change its ownership. This defines the probability of converting and ending the torture, 0..100.", },
        { val: "FoodGenerationSpeed", doc: "The speed at which the hatchery produces chickens", },
        ...
        { val: "BodyRemainsFor", doc: "Time before a body disappears and cannot be used for vampires anymore", },
        { val: "FightHateKillValue", doc: "How much an enemy will hate you for killing a unit. Negative values for love", },
        { val: "DungeonHeartHealth", doc: "The max health of a heart. Cannot exceed the short game limit of 32767", },
        ...
        { val: "PayDayProgress", doc: "Sets how far along you are to payday", },
        { val: "DoorSellValuePercent", doc: "The percentage of gold the player gets for selling doors", },
        { val: "TrapSellValuePercent", doc: "The percentage of gold the player gets for selling traps", },
        { val: "HungerHealthLoss", doc: "How much health units lose when hungry", },
        { val: "GameTurnsPerHungerHealthLoss", doc: "How often units lose health when hungry", },
        { val: "FoodHealthGain", doc: "How much health is gained from eating", },
        { val: "TortureHealthLoss", doc: "How much health is lost from torture", },
        ...
        { val: "BarrackMaxPartySize", doc: "Change this value to allow up to 30 units in a barracks party", },
        { val: "MaxThingsInHand", doc: "Change this value to allow up to 64 units in keeper's hand", },
        ...
        { val: "DeathMatchStatueReapperTime" },
        { val: "DeathMatchObjectReapperTime" },
        ...
        { val: "PlaceTrapsOnSubtiles", doc: "Traps can be placed on subtiles, allowing you to place up to 9 traps per tiles, enable with 1 or disable with 0.", },
        ...
        { val: "PowerHandGoldGrabAmount" },
        { val: "FriendlyFightAreaRangePercent", doc: "Percentage of spell area effect range used when inflicting friendly fire. This only affects values of AreaDamage, standard damage is not modified by it. Scaled 0..1000, where 100 is the value which makes friendly and enemy fire equal.", },
        { val: "FriendlyFightAreaDamagePercent", doc: "Percentage of area effect damage inflicted when friendly creatures are attacked. This only affects values of AreaDamage, standard damage is not modified by it. Scaled 0..1000, where 100 is the value which makes friendly and enemy fire equal.", },
        ...
        { val: "TimeBetweenPrisonBreak", doc: "Escape from prison is possible if it is next to an enemy slab. This defines the amount of game turns between a chance for breaking from jail 1..10000000.", },
        ...
        { val: "WorkshopTime" },
        { val: "ObservatoryTime" },
        { val: "ObservatoryGenerate" },
        { val: "DefaultGenerateSpeed" },
        { val: "DefaultMaxCreaturesGenerateEntrance" },
        { val: "DefaultNeutralEntranceLevel" },
        { val: "BarrackTime" },
        { val: "GraveyardConvertTime" },
        { val: "HitsPerSlab", doc: "Amount of hit points a single slab of a room has; used to compute complete amount of hit points of a room, which have to be depleted for the room to be taken over by enemy diggers.", },
